      ...
      <div className="space-y-2">
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="col-span-2">
            <div className="text-left">캐시 서버 리팩토링(사이드 프로젝트)</div>
            <div className="text-left">
              - 기술 스택: Spring Boot, Redis, AWS, Prometheus
            </div>
            <div className="text-left">
              - 모니터링 체계 구축, AWS 클라우드 마이그레이션
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="col-span-2">
            ...
            <div className="text-left">- 데이터 분석 및 AI 시스템 설계</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="col-span-2">
            <div className="text-left">우리 동네 랭킹(사이드 프로젝트)</div>
            <div className="text-left">
              - 기술 스택: Spring Boot, Redis, WebSocket, MongoDB
            </div>
            <div className="text-left">
              - 실시간 채팅 시스템 개발 및 성능 최적화
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="col-span-2">
            <div className="text-left">캐시 서버 개발(기업 프로젝트)</div>
            <div className="text-left">
              - 기술 스택: Spring Boot, Redis, WebClient, AWS
            </div>
            <div className="text-left">
              - Redis를 활용하여 캐시 서버 구축 및 성능 80% 개선
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="col-span-2">
            ...
            <div className="text-left">- 뉴스 음성 변환 서비스 구현</div>
          </div>
        </div>
      </div>
    </section>
